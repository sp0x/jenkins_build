...
RUN apt-get update && apt-get install -y \
    git curl apt-transport-https ca-certificates wget software-properties-common \
...
ARG JENKINS_VERSION
ENV JENKINS_VERSION ${JENKINS_VERSION:-2.131}

# jenkins.war checksum, download will be validated using it
ARG JENKINS_SHA=3d5b26d1f0e1fe4058b6c01e552c74cdbca3301e4e6fb7f79f8a1f138b7e326a
...
#Docker config
COPY docker.options /etc/default/docker
